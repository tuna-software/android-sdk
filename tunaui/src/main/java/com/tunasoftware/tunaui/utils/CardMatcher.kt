...
class CardMatcher {
    ...
    companion object {
        ...
        fun matches(number: String): CardFlag {
            ...
            return when {
                ("^(606282)".toRegex().matches(value)) || ("^(384100|384140|384160)".toRegex().matches(value)) -> CardFlag.HIPERCARD
                ...
                ("^(34|37)[0-9]{0,13}".toRegex().matches(value)) -> CardFlag.AMEX
                ("^(300|301|302|303|304|305|36|38)".toRegex().matches(value)) -> CardFlag.DINERS
                ("^4[0-9]{0,16}".toRegex().matches(value)) -> CardFlag.VISA
                ("^(5[1-5][0-9]{14}|2[2-7][0-9]{14})".toRegex().matches(value)) -> CardFlag.MASTER
